...
if __name__ == "__main__":
    ...
    PATH_TO_INPUT_BAG = '/home/li/Documents/Embedding-real-time-ML-algorithms-for-auto-cars/data/MIA/s1_p1_1.bag'
    SAVE_PATH = '/home/li/Documents/Embedding-real-time-ML-algorithms-for-auto-cars/data/MIA/s1_p1_1'
    ...
    for topic, msg, t in bag.read_messages(topics=topics):
        for ind, top in enumerate(topics):
            if topic == top:
                if topic == 'mux/ackermann_cmd_mux/output':
